...
class Animal implements intAnimal {
    ...
    image: string;
    teaserText: string;
    constructor(name: string, age: number, gender: string, size: string, vaccine: boolean, image: string, teaserText: string) {
        this.name = name;
        this.age = age;
        this.gender = gender;
        this.size = size;
...
class Cat extends Animal {
    ...
    fur_color: string;
    URL_breed: string;
    constructor(name: string, age: number, gender: string, size: string, vaccine: boolean, image: string, teaserText: string, breed: string, fur_color: string, URL_breed: string) {
...
class Dog extends Animal {
    breed: string;
    training: boolean;
    constructor(name: string, age: number, gender: string, size: string, vaccine: boolean, image: string, teaserText: string, breed: string, training: boolean) {
        super(name, age, gender, size, vaccine, image, teaserText);
        this.breed = breed;
